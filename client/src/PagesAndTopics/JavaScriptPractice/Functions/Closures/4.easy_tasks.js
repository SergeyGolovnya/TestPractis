...
//Необходимо разобраться, как он работает, а также что будет выведено в консоль и почему.
...
function f1(x) {
    ...
    // родительская функция возвращает внутреннюю функцию
    return f2;
  }
  ...
  console.dir(c1); // вывести детальную информацию о функции c1
  console.dir(c2); // вывести детальную информацию о функции c2
  console.log(c1(5)); // ?
  console.log(c2(5)); // ?