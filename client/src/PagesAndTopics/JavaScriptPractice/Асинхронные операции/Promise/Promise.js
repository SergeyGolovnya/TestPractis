...
/* Принимает в себя 2 аргумента: resolve и reject
resolve - функция, которая вызывается, когда промис выполнен успешно
reject - функция, которая вызывается, когда промис выполнен с ошибкой
 */
