...
// Отличие any от unknown и где что использовать
// any - это тип, который позволяет присваивать переменной любое значение
// unknown - это тип, который позволяет присваивать переменной любое значение, но сначала нужно проверить тип
